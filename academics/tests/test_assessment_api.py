...
class AssessmentAPITest(EnrollmentBaseSetup):
    def test_list_assessments_authenticated(self):
        Assessment.objects.create(section=self.section, name="Quiz", type="QUIZ", total_marks=10, date='2026-09-01')
    ...
    def test_create_assessment_as_teacher(self):
        ...
        data = {'section': self.section.id, 'name': 'Midterm', 'type': 'EXAM', 'total_marks': 50, 'date': '2026-09-15'}
